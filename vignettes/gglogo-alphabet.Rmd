...
alphabet_garamond$subgroup <- readr::parse_number(alphabet_garamond$pathGroup)

ggplot(alphabet_garamond, aes(x = x, y = y, group = pathGroup)) +
...
ggplot(alphabet_comic, aes(x = x, y = y, group = pathGroup)) +
  geom_polygon() +
  facet_wrap(~group, ncol = 13)
```
